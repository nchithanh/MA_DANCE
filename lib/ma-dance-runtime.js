...
const translations = {
  vi: {
    "nav.about":"Giới thiệu","nav.styles":"Styles","nav.classes":"Lớp học","nav.schedule":"Lịch","nav.services":"Dịch vụ","nav.instructors":"Giảng viên","nav.pricing":"Bảng giá","nav.branches":"Chi nhánh","nav.social":"Social","nav.contact":"Liên hệ","nav.book":"ĐẶT LỚP",
  ...
  en: {
    "nav.about":"About","nav.styles":"Styles","nav.classes":"Classes","nav.schedule":"Schedule","nav.services":"Services","nav.instructors":"Instructors","nav.pricing":"Pricing","nav.branches":"Branches","nav.social":"Social","nav.contact":"Contact","nav.book":"BOOK NOW",
  ...
  kr: {
    "nav.about":"소개","nav.styles":"스타일","nav.classes":"클래스","nav.schedule":"스케줄","nav.services":"서비스","nav.instructors":"강사","nav.pricing":"요금","nav.branches":"지점","nav.social":"소셜","nav.contact":"문의","nav.book":"예약하기",
...
// Header + chrome hide/show on scroll (Dolphin-style)
...
// ===== CLASSES TRACK (native overflow-x — no vertical→horizontal mapping) =====
function onScroll() {
  updateHeroShrink();
}
