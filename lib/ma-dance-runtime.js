...
import { isAdminSession, loginAdmin, logoutAdmin } from "./admin-auth";
...
const translations = {
  vi: {
    ...
    "hero.cta1":"Đăng ký học","hero.cta2":"Xem khóa","hero.ctaRoom":"Thuê phòng","hero.scroll":"SCROLL",
    ...
    "st.label":"Stories","st.title":"Chia sẻ từ studio","st.sub":"TikTok · YouTube · case studio — bấm để đọc hoặc xem clip.","st.all":"Xem tất cả stories →",
    "st.1.t":"Cover night tại studio","st.1.d":"Livestream cover · vibe phòng tập. Xem trên TikTok @madancestudio.",
    "st.2.t":"Class recap trong tuần","st.3.t":"MA × The New Gene 2026","st.4.t":"Không gian 3 chi nhánh",
    ...
    "inst.hye":"K-Pop · Hip-Hop — breakdown rõ, đúng count.","inst.min":"Girls Hip · Waacking — vibe mạnh, vào nhạc nhanh.","inst.jin":"Urban · Popping — kỹ thuật sạch, foundation chắc.","inst.soo":"K-Pop · Contemporary — cảm nhạc, line mềm.","inst.kai":"K-Pop · Cover — formation gọn, vào cam rõ.","inst.ren":"Waacking · Hip-Hop — tay sắc, groove chắc.","inst.yuna":"Girls Hip · Urban — energy lớp, dễ bắt nhịp.","inst.leo":"Hip-Hop · Locking — pocket rõ, foundation street.",
    "price.label":"Gói học phí","price.title":"Thu theo gói · 8 buổi/tháng","price.unit":"","price.note":"Giá xác nhận qua Zalo. Gói ≥ 3 tháng tặng bảo lưu · 6–12 tháng có cọc.",
    ...
    "gal.label":"Studio","gal.title":"Không gian 3 chi nhánh","gal.sub":"Q10 · Q3 · Phú Nhuận — ảnh phòng thật. Bấm để xem lớn.","gal.cta":"Thuê phòng","gal.hint":"Chạm","gal.a":"Phòng A — Main studio","gal.b":"Phòng B — Practice","gal.c":"Full mirror wall","gal.d":"Class energy","gal.e":"Evening session",
    "slide.prev":"Trước","slide.next":"Sau",
    ...
    "ct.formLead":"Mở form đăng ký chính thức — studio xác nhận qua Zalo.",
  ...
  en: {
    "nav.about":"About","nav.styles":"Styles","nav.classes":"Classes","nav.schedule":"Schedule","nav.services":"Services","nav.instructors":"Instructors","nav.pricing":"Pricing","nav.rooms":"Rooms","nav.events":"Choreo","nav.stories":"Stories","nav.branches":"Branches","nav.partner":"Partner","nav.milestones":"Milestones","nav.clients":"Brands","nav.social":"Social","nav.live":"Live","nav.contact":"Contact","nav.book":"BOOK NOW","nav.bookShort":"BOOK",
    "menu.eyebrow":"Menu",
    "menu.login":"Login","menu.logout":"Log out","menu.admin":"Admin",
    "menu.user":"Username","menu.pass":"Password","menu.loginGo":"Sign in",
    "menu.loginErr":"Wrong username or password.",
    ...
    "hero.cta1":"Book a class","hero.cta2":"View programs","hero.ctaRoom":"Rent a room","hero.scroll":"SCROLL",
    ...
    "st.label":"Stories","st.title":"From the studio","st.sub":"TikTok · YouTube · studio notes — read or watch.","st.all":"All stories →",
    "st.1.t":"Cover night at the studio","st.1.d":"Cover livestream · studio vibe. Watch on TikTok @madancestudio.",
    "st.2.t":"This week's class recap","st.3.t":"MA × The New Gene 2026","st.4.t":"Rooms across 3 branches",
    ...
    "inst.hye":"K-Pop · Hip-Hop — clear counts, stage-ready breakdowns.","inst.min":"Girls Hip · Waacking — strong vibe, quick musicality.","inst.jin":"Urban · Popping — clean technique, solid foundation.","inst.soo":"K-Pop · Contemporary — musical lines, soft control.","inst.kai":"K-Pop · Cover — tight formations, camera-ready.","inst.ren":"Waacking · Hip-Hop — sharp arms, solid groove.","inst.yuna":"Girls Hip · Urban — class energy, easy to follow.","inst.leo":"Hip-Hop · Locking — clear pocket, street foundation.",
    "price.label":"Pricing","price.title":"Monthly packs · 8 sessions","price.unit":"","price.note":"Price confirmed on Zalo. 3+ months include hold · 6–12 months may need a deposit.",
    ...
    "gal.label":"Studio","gal.title":"Rooms across 3 branches","gal.sub":"D10 · D3 · Phu Nhuan — real studio photos. Tap to enlarge.","gal.cta":"Rent a room","gal.hint":"Tap",
    "slide.prev":"Previous","slide.next":"Next",
  ...
  kr: {
    "nav.about":"소개","nav.styles":"스타일","nav.classes":"클래스","nav.schedule":"스케줄","nav.services":"서비스","nav.instructors":"강사","nav.pricing":"요금","nav.rooms":"룸","nav.events":"안무","nav.stories":"스토리","nav.branches":"지점","nav.partner":"파트너","nav.milestones":"이정표","nav.clients":"브랜드","nav.social":"소셜","nav.live":"라이브","nav.contact":"문의","nav.book":"BOOK NOW","nav.bookShort":"예약",
    "menu.eyebrow":"메뉴",
    "menu.login":"Login","menu.logout":"로그아웃","menu.admin":"Admin",
    "menu.user":"아이디","menu.pass":"비밀번호","menu.loginGo":"입장",
    "menu.loginErr":"아이디 또는 비밀번호가 올바르지 않습니다.",
    ...
    "hero.cta1":"수업 예약","hero.cta2":"프로그램 보기","hero.ctaRoom":"룸 대여","hero.scroll":"SCROLL",
    ...
    "st.label":"Stories","st.title":"스튜디오 이야기","st.sub":"TikTok · YouTube · 스튜디오 노트.","st.all":"스토리 전체 →",
    "st.1.t":"스튜디오 커버 나이트","st.1.d":"커버 라이브 · 스튜디오 바이브. TikTok @madancestudio.",
    "st.2.t":"이번 주 클래스 리캡","st.3.t":"MA × The New Gene 2026","st.4.t":"3개 지점 공간",
    ...
    "inst.hye":"K-Pop · Hip-Hop — 카운트 명확, 스테이지 브레이크다운.","inst.min":"Girls Hip · Waacking — 강한 바이브, 빠른 뮤지컬리티.","inst.jin":"Urban · Popping — 클린 테크닉, 단단한 기초.","inst.soo":"K-Pop · Contemporary — 음악적 라인, 부드러운 컨트롤.","inst.kai":"K-Pop · Cover — 포메이션 정돈, 카메라 대비.","inst.ren":"Waacking · Hip-Hop — 샤프한 암, 단단한 그루브.","inst.yuna":"Girls Hip · Urban — 클래스 에너지, 따라하기 쉬움.","inst.leo":"Hip-Hop · Locking — 명확한 포켓, 스트리트 기초.",
    "price.label":"요금","price.title":"월 패키지 · 8회","price.unit":"","price.note":"가격은 Zalo로 확인. 3개월 이상 홀드 포함 · 6–12개월은 보증금 가능.",
    ...
    "gal.label":"스튜디오","gal.title":"3개 지점 공간","gal.sub":"10군 · 3군 · 푸년 — 실제 룸 사진. 눌러서 확대.","gal.cta":"룸 대여","gal.hint":"탭",
    "slide.prev":"이전","slide.next":"다음",
...
const mobileLoginErr = document.getElementById("mobileLoginErr");
const mobileAuthIn = document.getElementById("mobileAuthIn");
const mobileLogout = document.getElementById("mobileLogout");

function syncMobileAuth() {
  const signed = isAdminSession();
  if (mobileLoginToggle) mobileLoginToggle.hidden = signed;
  if (mobileLoginForm) mobileLoginForm.hidden = true;
  if (mobileAuthIn) mobileAuthIn.hidden = !signed;
  if (mobileLoginErr) mobileLoginErr.hidden = true;
}

mobileLoginToggle?.addEventListener("click", () => {
  if (!mobileLoginForm) return;
  mobileLoginForm.hidden = !mobileLoginForm.hidden;
  if (mobileLoginErr) mobileLoginErr.hidden = true;
});
...
mobileLoginForm?.addEventListener("submit", (e) => {
  ...
  if (mobileLoginErr) mobileLoginErr.hidden = false;
});
...
function setActiveSpy(id) {
  ...
  if (activeLink && spyTrack) {
    ...
    const viewLeft = spyTrack.scrollLeft;
    const viewRight = viewLeft + spyTrack.clientWidth;
    if (linkLeft < viewLeft + pad) {
      spyTrack.scrollTo({ left: Math.max(0, linkLeft - pad), behavior: "smooth" });
    } else if (linkRight > viewRight - pad) {
      spyTrack.scrollTo({ left: linkRight - spyTrack.clientWidth + pad, behavior: "smooth" });
    }
  }
}
...
function syncMarquees() {
  ...
  document.querySelectorAll(".clients-track").forEach((track) => {
    ...
    const width = group.getBoundingClientRect().width;
    if (width <= 0) return;
    track.style.setProperty("--clients-shift", `${width}px`);
    track.style.setProperty("--clients-duration", `${Math.max(22, width / 40)}s`);
  });
}
syncMarquees();
window.addEventListener("resize", syncMarquees);

function initHSlides() {
  document.querySelectorAll("[data-hslide]").forEach((root) => {
    const track = root.querySelector("[data-hslide-track]");
    const prev = root.querySelector("[data-hslide-prev]");
    const next = root.querySelector("[data-hslide-next]");
    if (!track || !prev || !next) return;

    const step = () => {
      const card = track.querySelector(".inst-card, .hscroll-card, .gal-item, :scope > *");
      const row = card && card.parentElement !== track ? card.parentElement : track;
      const gap = Number.parseFloat(getComputedStyle(row).gap) || 16;
      return card ? card.getBoundingClientRect().width + gap : Math.max(200, track.clientWidth * 0.7);
    };
    const sync = () => {
      const can = track.scrollWidth > track.clientWidth + 12;
...
function initGalleryLightbox() {
  ...
  const hint = document.getElementById("galTapHint");
  const dismissHint = () => hint?.classList.add("is-done");
  ...
  if (hint && gallery) {
    ...
    hintIo.observe(gallery);
    hint.addEventListener("animationend", (e) => {
      if (e.animationName === "galTapHintLife") dismissHint();
    });
    gallery.querySelector(".gal-track")?.addEventListener("scroll", dismissHint, { passive: true, once: true });
  }
