...
const translations = {
  vi: {
    ...
    "ms.4.t":"Casting & studio","ms.4.d":"Tuyển giảng viên / dancer tại studio — 436A & 101 Đường 3/2, Quận 10.",
    ...
    "br.1.t":"MA Dance · Quận 10","br.1.a":"436A & 101 Đường 3/2, Quận 10, TP.HCM",
    "br.2.t":"MA Dance · Phú Nhuận","br.2.a":"Chi nhánh Phú Nhuận",
    "br.3.t":"MA Dance · Quận 3","br.3.a":"Chi nhánh Quận 3",
    "br.map":"Mở Maps →",
    ...
    "how.2.t":"Giữ chỗ","how.2.d":"Thanh toán / xác nhận qua Zalo hoặc form. Slot thường full trước 1–2 ngày.",
    ...
    "faq.3.q":"Có cần đăng ký trước không?","faq.3.a":"Nên giữ chỗ trước. Slot thường full 1–2 ngày. Nhắn Zalo 076 466 9969 hoặc gửi form trên web để confirm.",
    ...
    "ct.label":"Liên hệ","ct.title":"Nhắn để giữ chỗ","ct.desc":"Gửi form hoặc nhắn Zalo 076 466 9969. Team confirm lịch trong 1–2 giờ.",
    "ct.box":"Thông tin liên hệ",
    "ct.address":"Địa chỉ","ct.addressVal":"Q10: 436A & 101 Đường 3/2 · CN Phú Nhuận · CN Quận 3","ct.social":"Facebook","ct.phone":"Zalo / Phone","ct.email":"Email",
  ...
  en: {
    ...
    "ms.4.t":"Casting & studio","ms.4.d":"Instructor / dancer casting at the studio — 436A & 101 Duong 3/2, District 10.",
    ...
    "br.1.t":"MA Dance · Dist. 10","br.1.a":"436A & 101 Duong 3/2, District 10, HCMC",
    "br.2.t":"MA Dance · Phu Nhuan","br.2.a":"Phu Nhuan branch",
    "br.3.t":"MA Dance · Dist. 3","br.3.a":"District 3 branch",
    "br.map":"Open Maps →",
    ...
    "how.2.t":"Hold your spot","how.2.d":"Pay / confirm via Zalo or the form. Slots often fill 1–2 days ahead.",
    ...
    "faq.3.q":"Do I need to book ahead?","faq.3.a":"Yes, preferably. Slots often fill 1–2 days ahead. Message Zalo 076 466 9969 or use the form.",
    ...
    "ct.label":"Contact","ct.title":"Message to hold a spot","ct.desc":"Send the form or message Zalo 076 466 9969. We confirm within 1–2 hours.",
    "ct.box":"Contact details",
    "ct.address":"Address","ct.addressVal":"D10: 436A & 101 Duong 3/2 · Phu Nhuan · District 3","ct.social":"Facebook","ct.phone":"Zalo / Phone","ct.email":"Email",
  ...
  kr: {
    ...
    "ms.4.t":"캐스팅 & 스튜디오","ms.4.d":"강사·댄서 캐스팅 — 436A & 101 Đường 3/2, 10군.",
    ...
    "br.1.t":"MA Dance · 10군","br.1.a":"436A & 101 Đường 3/2, 10군, 호치민",
    "br.2.t":"MA Dance · Phu Nhuan","br.2.a":"Phu Nhuan 지점",
    "br.3.t":"MA Dance · 3군","br.3.a":"3군 지점",
    "br.map":"Maps 열기 →",
    ...
    "how.2.t":"자리 확보","how.2.d":"Zalo 또는 폼으로 결제/확인. 보통 1–2일 전 마감.",
    ...
    "faq.3.q":"사전 예약이 필요한가요?","faq.3.a":"네. 보통 1–2일 전 마감됩니다. Zalo 076 466 9969 또는 폼으로 예약하세요.",
    ...
    "ct.label":"문의","ct.title":"자리 예약 메시지","ct.desc":"폼 또는 Zalo 076 466 9969. 1–2시간 내 확인합니다.",
    "ct.box":"연락처 정보",
    "ct.address":"주소","ct.addressVal":"10군: 436A & 101 Đường 3/2 · 푸년 · 3군","ct.social":"Facebook","ct.phone":"Zalo / 전화","ct.email":"이메일",
...
document.getElementById("contactForm")?.addEventListener("submit", (e) => {
  ...
  if (!form.checkValidity()) {
    ...
    if (status) {
      ...
      status.textContent = t["ct.err"] || "Please fill in the required fields.";
    }
    return;
  }
  ...
  if (status) {
    ...
    status.textContent = t["ct.ok"] || "Got it — we'll reach out soon.";
  }
  setTimeout(() => {
