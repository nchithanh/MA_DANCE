...
const translations = {
  vi: {
    "nav.about":"Giới thiệu","nav.styles":"Styles","nav.classes":"Lớp học","nav.schedule":"Lịch","nav.services":"Dịch vụ","nav.instructors":"Giảng viên","nav.pricing":"Bảng giá","nav.branches":"Chi nhánh","nav.partner":"Đối tác","nav.milestones":"Dấu ấn","nav.social":"Social","nav.contact":"Liên hệ","nav.book":"ĐẶT LỚP",
    "menu.eyebrow":"Menu",
  ...
  kr: {
    "nav.about":"소개","nav.styles":"스타일","nav.classes":"클래스","nav.schedule":"스케줄","nav.services":"서비스","nav.instructors":"강사","nav.pricing":"요금","nav.branches":"지점","nav.partner":"파트너","nav.milestones":"이정표","nav.social":"소셜","nav.contact":"문의","nav.book":"예약하기",
    "menu.eyebrow":"메뉴",
